...
Config.Vehicles = {
    ...
    ["bcsm"] = "bcsm",
    ["Ford9000"] = "Ford9000",
    ["pete352custom"] = "pete352custom",
    ["17fontaine"] = "17fontaine",
    ["bcscorpion"] = "bcscorpion",
    ["eagerbeaver"] = "eagerbeaver",
    ["semihauler"] = "semihauler",
}

Config.Locations = {
    ["main"] = {
        label = "San Andreas Department Of Transportation",
        coords = vector4(2344.45, 3131.22, 48.61, 177.5),
    },
    ["vehicle"] = {
        label = "Flatbed",
        coords = vector4(2305.81, 3160.07, 48.32, 100.96),
    },
    ["dropoff"] = {
        label = "Vehicle Drop Off Location",
        coords = vector3(2346.26, 3102.41, 48.32)
    },
    ["towspots"] = {
